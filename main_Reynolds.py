...
plt.figure(1)
#plt.plot(CMc_tailOn[:-3,0],CMc_tailOn[:-3,1],'--x')
plt.plot(CMc_J16[:,0],CMc_J16[:,1],'--x')
plt.plot(CMc_J20[:,0],CMc_J20[:,1],'--x')
plt.plot(CMc_J24[:,0],CMc_J24[:,1],'--x')
#plt.legend([r'$C_{M,propOff}$',r'$C_{M,J=1.6}$',r'$C_{M,J=2.0}$',r'$C_{M,J=2.4}$'])
plt.legend([r'$U_{\infty} = 30$',r'$U_{\infty} = 40$',r'$U_{\infty} = 50$'])
...
plt.plot(CLc_J20[:,0],CLc_J20[:,1],'--x')
plt.plot(CLc_J24[:,0],CLc_J24[:,1],'--x')
